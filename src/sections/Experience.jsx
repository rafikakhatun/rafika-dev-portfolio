...
const Experience = () => {
  return (
    <section className="w-full bg-[#030014] py-20 md:py-24 px-4 sm:px-6 md:px-20">
        ...
        {experiences.map((exp, index) => {
          ...
          return (
            <div key={index} className="relative mb-12 md:mb-16">
              ...
              {/* Circle */}
              <div className="absolute left-1/2 transform -translate-x-1/2 w-8 h-8 md:w-10 md:h-10 rounded-full bg-[#030014] border-2 border-[#23D3EE] flex items-center justify-center z-10 shadow-[0_0_15px_#23D3EE]">
              ...
              <motion.div
                ...
                className={`w-full md:w-[45%] p-5 md:p-6 rounded-2xl bg-white/5 backdrop-blur-md border border-[#23D3EE]/20 shadow-lg shadow-[#23D3EE]/10 hover:shadow-[#23D3EE]/30 transition-all duration-300 ${
                  isLeft ? "ml-0 md:mr-auto" : "ml-0 md:ml-auto"
                }`}
              >
